...
<Table class="table table-striped">
    ...
    foreach ($mahasiswa as $row) : $no++; ?>
        <tr>
            ...
            <td><a href="<?php echo site_url('mahasiswa/edit/' . $row->nim); ?>"><i class="glyphicon glyphicon-edit"></i></a> edit </td>
            <td><a href="#" class="hapus" kode="<?php echo $row->nim; ?>">hapus<i class="glyphicon glyphicon-trash"></i></a></td>
        </tr>
    <?php endforeach; ?>
</Table>
<script>
